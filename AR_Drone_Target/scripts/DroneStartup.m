...
if isfile('AR_Drone_Target/registry/thirdpartytools/thirdpartytools_win32.xml') == 0 || ...
        isfile('AR_Drone_Target/registry/thirdpartytools/thirdpartytools_win64.xml') == 0
...
if isfile('AR_Drone_Target/registry/gcc_codesourcery_arm_linux_gnueabihf_gmake_win64_v4_8.mat') == 0
...
if isfile('AR_Drone_Target/blocks/videolib/AR_Drone_Front_Camera.tlc') == 0 ||...
        isfile('AR_Drone_Target/blocks/videolib/AR_Drone_Bottom_Camera.tlc') == 0
...
if isfile('AR_Drone_Target/blocks/rtwmakecfg.m') == 0 % the rtwmakecfg.m is created at the very end of Generate_AR_Drone_S_Functions
